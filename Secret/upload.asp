...
'	  oUpFileStream.Write Request.BinaryRead (RequestSize)
	  do while ReadedBytes < RequestSize					'使用循环读取用户发送的数据，iis6默认不能读取大于200K的数据
		oUpFileStream.Write Request.BinaryRead(204800)
		ReadedBytes = ReadedBytes + 204800
	  loop
