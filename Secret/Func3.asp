...
Function TotalScore(ExamineId)
	...
	if intGetGradeState(ExamineId,0)="4" then
		...
		StrSql="select EI.ExamineId, Sum(case EI.MarksType when 0 then isnull(convert(decimal(10,2),round(Marks*Weighing/100,2)),0) else isnull(convert(decimal(10,2),round(Marks*Weighing,2)),0) end) Marks  "&_
...
Function FactorScore(ExaItemId)
	...
	if intGetGradeState(ExaItemId,1)="4" then
		...
		StrSql="select EI.ExamineId,case EI.MarksType when 0 then isnull(convert(decimal(10,2),round(Marks*Weighing/100,2)),0) else isnull(convert(decimal(10,2),round(Marks*Weighing,2)),0) end Marks "&_
		"from ExamineItem EI "&_
		"left join (select ExaItemId,sum(isnull(convert(decimal(10,2),round(Weighing*Marks/100,2)),0)) as Marks "&_
...
Function ExaTotalScore(ExamineId,EmpCode)
	...
	if intGetGradeState(ExamineId,0)="4" then
		...
		StrSql="select EI.ExamineId,EET.ExaEmpCode, "&_
		"sum(case EI.MarksType when 0 then isnull(convert(decimal(10,2),round(Marks*Weighing/100,2)),0) else isnull(convert(decimal(10,2),round(Marks*Weighing,2)),0) end) Marks "&_
		"from ExamineItem EI "&_
...
Function ExaFactorScore(ExaItemId,EmpCode)
	...
	if intGetGradeState(ExaItemId,1)="4" then
		...
		StrSql="select EI.ExamineId,EI.ExaItemId,EET.ExaEmpCode, "&_
		"case EI.MarksType when 0 then isnull(convert(decimal(10,2),round(Marks*Weighing/100,2)),0) else isnull(convert(decimal(10,2),round(Marks*Weighing,2)),0) end Marks "&_
		"from ExamineItem EI "&_
		"left join (select ExaItemId,ExaEmpCode,isnull(convert(decimal(10,2),round(Weighing*Marks/100,2)),0) as Marks "&_
		"from ExaEmpTab) EET on EET.ExaItemId=EI.ExaItemId "&_
		"where EI.ExaItemId="&ExaItemId&" and EET.ExaEmpCode='"&EmpCode&"'"
